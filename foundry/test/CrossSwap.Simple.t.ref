...
contract CrossSwapTest is Test, Fixtures {
    ...
    function setUp() public {
        ...
        address flags = address(uint160(Hooks.BEFORE_ADD_LIQUIDITY_FLAG | Hooks.BEFORE_SWAP_FLAG) ^ (0x4444 << 144));

        bytes memory constructorArgs =
            abi.encode(manager, authorizedUser, originalHookChainId, address(0xBEEF), zkVerifier);
